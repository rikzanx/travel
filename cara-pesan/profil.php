    ...
    <tbody>
        <tr>
           <th class="text-left">Nama/Email</th>
            <th class="text-left"><abbr title="Email tidak dapat dirubah!"><em><?php echo $tampil['nama_user']; ?></em></abbr></th>
        </tr>
        <tr>
        ...
        <tr>
           <th class="text-left">Telepon</th>
            <th class="text-left"><abbr title="Email tidak dapat dirubah!"><em><?php echo $tampil['no_telepon']; ?></em></abbr></th>
        </tr>
        <tr>
