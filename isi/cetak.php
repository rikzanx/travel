<?php 
	...
	$pdf= new PDF_BARCODE("P","cm","Letter");
...
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Website : res-train.com Email : customer@res-train.com',0,'L');
...
while($baris = mysqli_fetch_array($hasil))
{
    ...
    $pdf->Ln();
    $pdf->Image('http://localhost/travel/isi/barcode.php?f=png&s=code-128&d='.$baris["id_pesan"],15,5,3,2,"png");
    $pdf->Cell(5,0.8,"Jurusan        ",0,0,'L');
    $pdf->Cell(2,0.8,": ",0,0,'L');
    $jurusan=$baris['nama_stasiun_asal']." - ".$baris['nama_stasiun_tujuan'];
    $pdf->Cell(3,0.8,$jurusan,0,0,'L');
    $pdf->Ln();
    ...
    $pdf->Cell(1,0.8,$baris['harga'].",00",0,0,'L');
	$pdf->Ln();
