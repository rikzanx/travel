...
kereta.id_kereta = jadwal.id_kereta and user.id_user = pesan.id_user and pesan.id_pesan = pesan.id_pesan and pesan.id_jadwal = jadwal.id_jadwal and jadwal.id_stasiun_asal = 
stasiun_asal.id_stasiun_asal and jadwal.id_stasiun_tujuan = stasiun_tujuan.id_stasiun_tujuan and konfirmasi_pesan.id_pesan = pesan.id_pesan AND status='Lunas'AND tgl_transfer BETWEEN '$tglawal' AND '$tglakhir' ";
  $hasil = mysqli_query($kdb1, $sql);
    while($r=mysqli_fetch_array($hasil)){
  $harga =$r[harga];
  $subtotal= $harga + $subtotal;
       echo "
       <td>$r[id_pesan]</td>
       <td>$r[nama_stasiun_asal] - $r[nama_stasiun_tujuan]</td>
