...
<td> <input type = "text" name="id_jadwal" id="id_jadwal" maxlength="22" size="22" value="<?php  echo trim ($row["nama_stasiun_asal"])?>"readonly/> -
<input type = "text" name="id_jadwal" id="id_jadwal" maxlength="22" size="22" value="<?php  echo trim ($row["nama_stasiun_tujuan"])?>"readonly/></td>
</tr>
<tr>
<td width="200px">Member</td>
<td> <input type = "text" name="id_muser id="id_user" maxlength="50" size="50" value="<?php  echo trim ($row["username"])?>"readonly/></td>
</tr>
<tr>
...
Kota Keberangkatan  = <?php echo $row['nama_stasiun_asal'];?><br> 
Kota Tujuan = <?php echo $row['nama_stasiun_tujuan'];?><br> 
...
Nomor Kursi = <?php echo $row['nomor_bangku'];?><br> 
...
{
  global $kdb1;
$sql =  "select * from konfirmasi_pesan, user, pesan, jadwal, stasiun_asal, stasiun_tujuan, stasiun where 
stasiun.id_kereta = jadwal.id_kereta and user.id_user = pesan.id_user and pesan.id_pesan = pesan.id_pesan and 
