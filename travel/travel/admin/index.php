  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li <?php if($form==18) { echo 'class="active"'; } else { echo 'class=""'; } ?> >
            <a class="" href="index.php?form=18">
                <i class="fa fa-circle-o"></i> 
                <span>Pengecekan Tket</span>
            </a>
        </li>
        <li class="treeview">
          <a href="#">
...
<li <?php if($form==15) { echo 'class="active"'; } else { echo 'class=""'; } ?>><a class="" href="index.php?form=15"><i class="fa fa-circle-o"></i>Konfirmasi Belum Bayar</p></a></li>
       ...
       <?php global $kdb1;
$result="SELECT count(*) as total from keluhan, user where keluhan.id_user=user.id_user";
$sqli = mysqli_query($kdb1,$result);
$data=mysqli_fetch_assoc($sqli);
echo $data['total']; ?></small></a></span>
  ...
  <?php	
                ...
                case('17'): include_once('./form/pengecekan.php'); break; 		
