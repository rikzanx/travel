	  ...
	  <div class="panel panel-default" style="color:black">
        ...
        <div class="panel panel-primary">
            <div class="panel-body" style="color:black;">         
                                                          ...
                                                          <div class="col-md-12 ">
                                                             <form class="form-controll" action="tiket.php?menu=18&i=<?php echo $row -> id_pesan; ?>" method="post">
                                                                <?php 
                                                                ...
                                                                <div class="form-group row col-md-12">
                                                                  <label for="example-text-input" class="col-xs-2 col-form-label">No resi Tranfer</label>
                                                                  <div class="col-xs-10">
